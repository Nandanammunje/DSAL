...
public class TreeStarter {
	...
	public static void main(String[] args) {
		...
		TreeOps opsTree1 = new TreeOpsImpl();
		TreeOps opsTree2 = new TreeOpsImpl();
		...
		GenericTreeEntity root1 = opsTree1.mkGenericTree(preOrderSequence, inorderSequence);
		inorderSequence = "";
		preOrderSequence = "";
		System.out.println("Enter the size for second tree");
		treeSize = sc.nextInt(); 
